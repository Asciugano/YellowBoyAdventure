...
//        projectile = new OBJ_Rock(gp);
        ...
        if(i != -1){
            if(!gp.monster[gp.currentMap][i].invincible){
                ...
                if(gp.monster[gp.currentMap][i].life <= 0){
                    ...
                    gp.ui.addMessage("hai ucciso " + gp.monster[gp.currentMap][i].name + "!");
    ...
    public void checkLevelUp() {
        ...
        if(exp >= nextLevelExp){
            ...
            gp.ui.currentDialogue = "Sei al livello" + level + "\nAdesso sei più forte!";
        }
    }
    ...
    public void selectItem() {
        ...
        if(itemIndex < inventory.size()){
            ...
            if(selectedItem.type == typeAxe || selectedItem.type == typeSword){
        ...
        if (i != -1) {
            ...
            switch (OBJname){
                case "Key":
                    ...
                    gp.obj[i] = null;
                    gp.playSE(1);
                    gp.ui.showMessage("Hai trovato una Chiave!!");
                    break;
                case "Door":
                    if(hasKey > 0){
                        hasKey --;
                        ...
                        gp.ui.showMessage("Non hai la chiave, Trovala!!");
                    }
                    break;
                case "Boots":
                    speed += 2;
                    gp.obj[i] = null;
                    gp.playSE(2);
                    gp.ui.showMessage("Hai trovato degli Stivali, adesso sarai più Veloce!!");
                    break;
                case "Chest":
    ...
    public void draw(Graphics2D g2) {
        ...
        int rigthOffset = gp.screenWidth - screenX;
        if (rigthOffset > gp.worldWidth - worldX) {
