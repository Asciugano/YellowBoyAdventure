...
public class EventHandler {
    ...
    public boolean hit(int col, int row, String repDirection, int map) {
        ...
        if(map == gp.currentMap) {
            ...
            if (gp.player.solidArea.intersects(eventRect[map][col][row]) && !eventRect[map][27][16].eventDone) {
                if (gp.player.direction.contentEquals(repDirection) || repDirection.contentEquals("any")) {
    ...
    public void damagePit(int gameState) {
        ...
        gp.playSE(6);
        gp.ui.currentDialogue = "Hai preso una storta";
        gp.player.life--;
    ...
    public void healingPool(int gameState) {
        ...
        if (gp.player.life < gp.player.maxLife || gp.player.mana < gp.player.maxMana) {
            if (gp.keyH.enterPressed) {
                ...
                gp.playSE(2);
                gp.ui.currentDialogue = "Hai bevuto un'acqua magica...\nhai recuperato tutta la vita\ne tutti i mana";
    ...
    public void teleport(int gameState) {
        gp.gameState = gameState;
        gp.ui.currentDialogue = "Hai preso un portale che ti porterà...\nlontano";
